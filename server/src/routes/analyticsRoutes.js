...
import { ingestEvents, getWeeklyRetention, getUserWeeklyRetention, getInteractionSummary, seedDummyData, removeSeededData, getStudentInteractions } from "../controllers/analyticsController.js";
...
router.get("/student-interactions/:classroomId", protect, getStudentInteractions); // Student interaction network
